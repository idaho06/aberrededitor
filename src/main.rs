...
fn main() -> Result<(), String> {
    ...
    EngineBuilder::new()
        ...
        .add_observer(systems::map_ops::add_font_observer)
        .add_observer(systems::map_ops::rename_font_key_observer)
        .add_observer(systems::map_ops::remove_font_observer)
        .add_observer(systems::map_ops::preview_mapdata_observer)
        .add_observer(systems::map_ops::add_animation_observer)
        .add_observer(systems::map_ops::update_animation_resource_observer)
        .add_observer(systems::map_ops::rename_animation_key_observer)
        .add_observer(systems::map_ops::remove_animation_observer)
        ...
        .add_observer(systems::entity_edit::move_multi_selection_observer)
        .add_observer(systems::entity_edit::adjust_multi_selection_z_observer)
        ...
        .add_observer(systems::entity_edit::update_lua_setup_observer)
        .add_observer(systems::entity_edit::remove_lua_setup_observer)
        .add_observer(systems::entity_edit::update_dynamic_text_observer)
        .add_observer(systems::entity_edit::remove_dynamic_text_observer)
